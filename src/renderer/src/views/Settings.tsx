...
export function SettingsView({ settings, save, update, api, run, extensionConnected, themeMedia, onToast }: Props) {
  ...
  return (
    <div className="settings">
      <div className="card section">
        ...
        <p className="section-note">Animated worlds inspired by the destinations. Heavier than the core themes, so set here — the sidebar switch keeps to the four above.</p>
        ...
        {destination && (
          <>
            ...
            <Row label="Background dimming" desc="How much to darken a custom background so text stays readable.">
              <input
                className="range"
                type="range"
                min={0}
